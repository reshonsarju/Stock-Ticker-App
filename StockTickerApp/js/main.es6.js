(()=> {
    ...
    const tickerDisplay = (data, element) =>{
        ...
        let {"2. Symbol": tickerSymbol} = symbolInfo;
        ...
        let {"1. open": openPrice, "2. high": priceHigh,"3. low": priceLow, "4. close": closePrice} = tickerInfo[currentDate];
